...
class Theme(models.Model):
    ...
    css_module_menu_enabled = models.BooleanField(
        ...
        help_text=mark_safe(
            ...
            "to a subclass of <code>MenuManager</code>:"
            "<pre style='margin:8px 0;padding:10px 14px;background:#f6f6f6;border:1px solid #ddd;border-radius:4px;font-size:12px;line-height:1.5'>"
            "ADMIN_INTERFACE_MENU = 'myapp.admin_menu.MenuConfig'"
            "</pre>"
            "<pre style='margin:0;padding:10px 14px;background:#f6f6f6;border:1px solid #ddd;border-radius:4px;font-size:12px;line-height:1.5'>"
